...
exports.x12270271CompleteQuestionnaire = void 0;
const questionnaire_1 = require("../types/questionnaire");
exports.x12270271CompleteQuestionnaire = {
    ...
    sections: [
            ...
            questions: [
                {
                    ...
                    type: questionnaire_1.QuestionType.TEXT,
                ...
                },
                {
                    ...
                    type: questionnaire_1.QuestionType.DATE,
            ...
            questions: [
                {
                    ...
                    type: questionnaire_1.QuestionType.RADIO,
                ...
                },
                {
                    ...
                    type: questionnaire_1.QuestionType.DISPLAY,
        ...
        },
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    type: questionnaire_1.QuestionType.EMAIL,
        ...
        },
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    type: questionnaire_1.QuestionType.TEXTAREA,
            ...
            questions: [
                {
                    ...
                    type: questionnaire_1.QuestionType.CHECKBOX,
        ...
        },
        {
            ...
            conditionalLogic: {
                requiredModes: [questionnaire_1.ImplementationMode.REAL_TIME_WEB]
            },
            questions: [
                {
            ...
            questions: [
                {
                    ...
                    type: questionnaire_1.QuestionType.FILE_UPLOAD,
        ...
        },
        {
            ...
            questions: [
                ...
                {
                    id: 'test-url-web',
                    type: questionnaire_1.QuestionType.URL,
                    title: 'Test URL(s)',
                    description: '',
                    required: true,
                    attachmentRequired: false,
        ...
        },
        {
            ...
            conditionalLogic: {
                requiredModes: [questionnaire_1.ImplementationMode.REAL_TIME_B2B]
            },
            questions: [
                {
        ...
        },
        {
            ...
            modeLabel: 'EDI batch',
            conditionalLogic: {
                requiredModes: [questionnaire_1.ImplementationMode.EDI_BATCH]
            },
            questions: []
        },
        {
...
//# sourceMappingURL=x12-270-271-complete.js.map